...
export default function Home() {
  ...
  return (
    <div className={`${tomorrow.className} min-h-screen bg-[#031f56] text-[#c6cceb] flex flex-col`}>
      {/* Navbar */}
      <nav className="flex justify-between items-center flex-wrap gap-4 px-4 sm:px-6 py-4 mx-4 mt-5 rounded-full border border-[#9765db]/30">
        <div
          className="text-2xl sm:text-3xl font-extrabold bg-gradient-to-r from-[#f682a0] to-[#9765db] bg-clip-text text-transparent"
        >
          ZUNO
        </div>
      ...
      <main className="flex flex-col items-center justify-center flex-grow px-4 text-center">
        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-[#f682a0] via-[#9765db] to-[#c6cceb] bg-clip-text text-transparent break-words">
          Zuno
        </h1>
        ...
        <div className="w-full max-w-md">
          {!submitted ? (
            ...
            >
              ...
              <button
                type="submit"
                className="px-6 py-3 font-semibold rounded-md bg-gradient-to-r from-[#f682a0] to-[#9765db] hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#f682a0] transition w-full sm:w-auto"
              >
                Join&nbsp;Waitlist
              </button>
            </form>
      ...
      <footer className="flex flex-col sm:flex-row justify-between items-center gap-3 px-4 sm:px-6 py-4 text-sm text-[#c6cceb]/80 text-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-[#f682a0]">Next.js</span>
        </div>
      </footer>
    </div>
  );
